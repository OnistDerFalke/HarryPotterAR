...
namespace Assets.Scripts
{
    public static class BoardInitializator
    {
        ...
        private static void InitFirstBoard()
        {
            ...
            // Wieża zegarowa
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(9.2f, 17.3f), new Vector2(11.8f, 17.3f), new Vector2(11.8f, 14.8f), new Vector2(9.2f, 14.8f)), 3, true, isMissionField: true));
            // Skrzydło szpitalne
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(10.4f, 22.0f), 1.5f), 7, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(21.75f, 21.7f), 1.7f), 11, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(22.6f, 9.7f), 2.0f), 15, true));
            // Gabinet Dumbledore'a
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(20.6f, 6.8f), 1.5f), 16, isMissionField: true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(10.5f, 10.3f), 1.6f), 20, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(43.05f, 20.15f), 1.5f), 41, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(43.05f, 25.7f), 1.5f), 43, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(28.85f, 25.85f), 1.5f), 48, true, isMissionField: true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(28.85f, 20.15f), 1.5f), 50, true));
            ...
            // Wieża centralna
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(37.4f, 31.7f), 1.6f), 56, true));
            ...
            // Transmutacja
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(43.1f, 31.1f), 1.5f), 58, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(42.0f, 41.5f), 1.7f), 62, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(32.8f, 41.6f), 1.7f), 68, true));
            // Wierzba bijąca
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(27.8f, 46.9f), new Vector2(33.3f, 46.9f), new Vector2(33.3f, 44.2f), new Vector2(27.8f, 44.2f)), 69, isMissionField: true));
            ...
            // Zaklęcia i uroki
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(31.5f, 37.1f), 1.5f), 70, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(31.7f, 31.3f), 1.5f), 72, true));
            ...
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(19.7f, 30.9f), 2.0f), 77, true, isMissionField: true));
            // Most wiszący
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(18.4f, 28.45f), new Vector2(20.6f, 28.3f), new Vector2(20.0f, 23.4f), new Vector2(18.25f, 23.4f)), 78, isMissionField: true));
            ...
            // Komnata Tajemnic
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(15.8f, 35.5f), new Vector2(18.65f, 35.4f), new Vector2(18.65f, 33.0f), new Vector2(15.9f, 33.0f)), 80, isMissionField: true));
            // Pokój życzeń
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(21.8f, 35.6f), new Vector2(30.1f, 35.6f), new Vector2(30.2f, 32.6f), new Vector2(21.8f, 32.6f)), 81, isMissionField: true));
            // Wieża z eliksirem obok pokoju życzeń
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(30.1f, 37.1f), 1.5f), 82, true));
            ...
            // Biblioteka
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(20.1f, 42.6f), 1.8f), 87, true));
            ...
            // Zakazany las
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(15.6f, 10.1f), 1.5f), 92, isMissionField: true));
            // Boisko do quidditcha
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(15.2f, 45.4f), 1.8f), 93, isMissionField: true, isQuidditchPitch: true));
            ...
            // Chatka Hagrida
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(10.7f, 43.1f), 1.7f), 95, isMissionField: true));
            // Smocza Arena
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(5.9f, 45.0f), 2.2f), 96, isMissionField: true));
            // Sprawowanie obok opieki nad magicznymi stworzeniami
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(9.7f, 10.8f), 1.1f), 97));
            ...
            // Jezioro
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(9.6f, 28.9f), new Vector2(16.4f, 29.8f), new Vector2(17.4f, 25.3f), new Vector2(8.7f, 25.3f)), 101, isMissionField: true));
        }
        ...
        private static void InitSecondBoard()
        {
            ...
            // Bank Gringotta
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Circle(new Vector2(8.9f, 20.7f), 2.2f), 106, isMissionField: true));
        ...
        private static void InitThirdBoard()
        {
            ...
            // Bank Gringotta
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(9.1f, 8.3f), new Vector2(16.0f, 8.3f), new Vector2(16.0f, 1.4f), new Vector2(9.1f, 1.4f)), 122, isMissionField: true, isFiuuField: true));
            // Ministerstwo Magii
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(1.1f, 8.3f), new Vector2(8.0f, 8.3f), new Vector2(8.0f, 1.4f), new Vector2(1.1f, 1.4f)), 123, isMissionField: true, isFiuuField: true));
            // Grimmauld Place 12
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(17.2f, 16.3f), new Vector2(24.1f, 16.3f), new Vector2(24.1f, 9.4f), new Vector2(17.2f, 9.4f)), 124, isFiuuField: true));
            // Nora
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(9.1f, 16.3f), new Vector2(16.0f, 16.3f), new Vector2(16.0f, 9.4f), new Vector2(9.1f, 9.4f)), 125, isFiuuField: true));
            // Sala przepowiedni
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(1.1f, 16.3f), new Vector2(8.0f, 16.3f), new Vector2(8.0f, 9.4f), new Vector2(1.1f, 9.4f)), 126, isMissionField: true, isFiuuField: true));
            // Forest of dean
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(17.2f, 24.2f), new Vector2(24.1f, 24.2f), new Vector2(24.1f, 17.3f), new Vector2(17.2f, 17.3f)), 127, isMissionField: true, isFiuuField: true));
            // Dwór Malfoya
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(9.1f, 24.2f), new Vector2(16.0f, 24.2f), new Vector2(16.0f, 17.3f), new Vector2(9.1f, 17.3f)), 128, isFiuuField: true));
            // Cmentarz w Little Hangleton
            GameManager.BoardManager.Boards[boardId].Fields.Add(new Field(boardId, new Quadrangle(
                new Vector2(1.1f, 24.2f), new Vector2(8.0f, 24.2f), new Vector2(8.0f, 17.3f), new Vector2(1.1f, 17.3f)), 129, isMissionField: true, isPortkeyField: true));
        }
